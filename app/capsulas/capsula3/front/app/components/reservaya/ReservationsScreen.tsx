...
export function ReservationsScreen({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-red-50">
                ...
                >
                  ...
                  <div className="p-5 bg-white space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="flex flex-col items-center gap-2 p-3 bg-orange-50 rounded-xl border-2 border-orange-200">
                        <Calendar className="h-5 w-5 text-orange-600" />
      ...
      >
        <DialogContent className="max-w-sm border-4 border-green-300 rounded-3xl p-0 gap-0">
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 px-4 py-4 text-center relative">
            <Button
              variant="ghost"
              size="icon"
            ...
            <DialogTitle className="text-white mb-1 text-lg">
              ¡Reserva Confirmada!
            </DialogTitle>
          ...
          {selectedReservation && (
            <div className="p-4 bg-white">
              {/* QR Code */}
              <div className="bg-white border-4 border-green-200 rounded-2xl p-4 mb-4 flex items-center justify-center">
                <div className="relative" ref={qrRef}>
                  ...
                  <div className="absolute -top-2 -right-2 w-10 h-10 bg-green-500 rounded-full flex items-center justify-center border-4 border-white shadow-lg">
              ...
              {/* Reservation Code */}
              <div className="bg-orange-50 border-2 border-orange-200 rounded-xl p-3 mb-4 text-center">
                <p className="text-slate-600 mb-1 text-sm">Código de Reserva</p>
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  ...
                  variant="outline"
                  className="h-10 border-2 border-orange-300 text-orange-600 hover:bg-orange-50 rounded-xl text-sm"
                >
                ...
                <Button
                  ...
                  className="h-10 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-xl shadow-lg text-sm"
                >
